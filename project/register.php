            ...
            <div class="p-5 my-5 bg-white shadow rounded-3">
                ...
                <form action="./register" method="POST" class="mb-4">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" name="name" placeholder="First name" pattern="^[^'\x22`]+$" minlength="4" maxlength="32" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="phone" class="form-control" id="floatingInput" name="phone" placeholder="+37000000000" pattern="^\+370[0-9]{8}$" required>
                        <label for="floatingInput">Phone number</label>
                        <div id="passwordHelpBlock" class="form-text">
                            Phone number has to start with +370.
                        </div>
                    </div>
